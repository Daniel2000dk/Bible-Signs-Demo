    ...
    >
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative p-2 text-bs-dark hover:text-bs-black transition-colors"
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-bs-gold text-bs-black text-[9px] font-bold rounded-full flex items-center justify-center">
                  {cartCount}
                </span>
              )}
            </button>
            ...
            >
              Kies jouw BibleSign
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.8" className="translate-x-0 group-hover:translate-x-0.5 transition-transform">
      ...
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ${
          mobileOpen ? 'max-h-80 border-t border-bs-sand' : 'max-h-0'
        } bg-bs-offwhite`}
      >
